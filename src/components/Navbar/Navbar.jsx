...
import { Search, Bookmark, ShoppingCart, CircleUserRound, ArrowLeftFromLine } from 'lucide-react';
...
export default function Navbar() {
  ...
  return (
    <>
      <header className="
      relative 
      flex flex-row justify-between items-center lg:justify- 
      py-3 px-2 xs:px-4 sm:px-6 md:px-8 lg:px-12 2xl:px-24! 
      text-white bg-main 
      transition-all ease-in-out duration-500"
      >

        <Link to="/" className="font-bold text-lg text-base-1 hover:opacity-70">
          <i>Omnia</i>
        </Link>
